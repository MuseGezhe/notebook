...
class Addresses(models.Model):
    ...
    class Meta():
        db_table = 'addresses'
    @classmethod
    def create(cls,name,sex,phoneNum,province,city,county,street,detail_address,user):
        return cls(name=name,sex=sex,phoneNum=phoneNum,province=province,city=city,county=county,street=street,detail_address=detail_address,user=user)
